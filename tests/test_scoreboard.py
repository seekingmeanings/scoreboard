...
def test_create_structure_creates_correct_digits():
    scoreboard = Scoreboard(
        character_config_file='config/characters.toml',
        board_config_file='config/board_layout.toml',
        virtual=True
    )
    scoreboard.config = {
        "boards": {
...
def test_display_char_turns_off_all_leds_when_character_is_none():
    scoreboard = Scoreboard(character_config_file='path/to/character_config.toml',
                            board_config_file='path/to/board_config.toml')
    scoreboard.digits = {
